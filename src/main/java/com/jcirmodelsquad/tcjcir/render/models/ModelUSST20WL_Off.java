...
public class ModelUSST20WL_Off extends ModelConverter //Same as Filename
{
    int textureX = 128;
    int textureY = 32;

    public ModelUSST20WL_Off() //Same as Filename
    {
    ...
    private void initbodyModel_1()
    {
        ...
        bodyModel[35].setRotationPoint(-1.75F, 7.5F, 2F);
